...
export default function MapView(props) {
  ...
  return (
    ...
    <div id="map-view-container">
      ...
      <h2 className="page-title">Currently: <span className="technically">{getTotalOpenStates}/51</span> states meet the guidelines to open.</h2>
